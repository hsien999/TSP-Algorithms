...
from .local_optimization import LocalOptimizationHeuristics
...
class GeneticAlgorithm(LocalOptimizationHeuristics):
    crossovers = {
        'OC': 'order_crossover',
    ...
    def __init__(self, filepath):
        ...
        self.crossover = self.crossovers['OC']
        self.mutation = self.mutations['SWAP']
    ...
    @staticmethod
    def _partial_mapping(i1, i2, ni1, ni2, a, b):
        for x in i2[a:b]:
            if x in i1[a:b]:
                continue
            curr = x
    ...
    def partially_mapped_crossover(self, i1, i2):
        ...
        self._partial_mapping(i1, i2, ni1, ni2, a, b)
        self._partial_mapping(i2, i1, ni2, ni1, a, b)
    ...
    def genetic(self, generation, **data):
